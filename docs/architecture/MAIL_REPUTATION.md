...
and delivery errors for `gulyaly.com` (registered 2026-09-19; newsletter now sends as
`news@gulyaly.com`, so there is a single sending identity):
1. Sign in with a Google account and add `gulyaly.com`.
